package cn.com.taiji.utils.lang;
...
public class XRegex {
	...
	public String escapeRegex(String original) {
	...
	public String escapeDollarBackslash(String original) {
	...
	public Set<String> find(String input, Pattern p) {
	...
	public static boolean IsTelephone(String str) {
		String regex = "(^(\\d{3,4}-)?\\d{6,8}$)|^(\\d{6,8}-\\d{3,4}$)|^(\\d{3,4}-\\d{6,8}-\\d{3,4}$)";
		return match(regex, str);
	}
	...
	public static boolean IsHandset(String str) {
		//String regex = "^((//(//d{3}//))|(//d{3}//-))?(13//d{9}|14//d{9}|15//d{9}|18//d{9})$";
