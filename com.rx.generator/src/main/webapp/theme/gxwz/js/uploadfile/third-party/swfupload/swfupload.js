...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	...
	if (window.ActiveXObject) { 
		...
		if (Sys.ie &&( Sys.ie.substring(0, 1) == "9" || Sys.ie.substring(0, 2) == "10" || Sys.ie.substring(0, 2) == "11")) { 
...
SWFUpload.prototype.getFileUploadLimit = function () {
	return this.settings.file_upload_limit;
};
