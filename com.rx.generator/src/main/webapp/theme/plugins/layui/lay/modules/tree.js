...
function(e) {
    ...
    t = {
        	arrow: ["<img src='/theme/platform/css/icons/arrow_right_16.png'/>", "<img src='/theme/platform/css/icons/bullet_arrow_down.png'/>"],
        	checkbox: ["&#xe626;", "&#xe627;"],
        	radio: ["&#xe62b;", "&#xe62a;"],
        	branch: ["&#xe622;", "&#xe624;"],
        	leaf: "&#xe621;"
    ...
    r.prototype.tree = function(e, a) {
        ...
        function(a, n) {
            ...
            function() {
                return '<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"': "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch": "leaf") + '">' + (l ? n.spread ? '<img src="'+n.imgpath+'"/>' : '<img src="'+n.imgpath+'"/>' : '<img src="'+n.imgpath+'"/>') + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")
            } (), "</li>"].join(""));
    ...
    r.prototype.spread = function(e, o) {
        ...
        n = e.children("a"),
        l = function() {
            e.data("spread") ? (e.data("spread", null), r.removeClass("layui-show"), i.html(t.arrow[0])) : (e.data("spread", !0), r.addClass("layui-show"), i.html(t.arrow[1]))
        };
