...
import cn.com.taiji.generator.repository.ModelSysExportRepository2;
...
*/
@Service
public class ModelSysImpl2  implements ModelSysService2{
	...
	@Inject
	ModelSysExportRepository2 modelSysExportRepository2;
...
//				}
			  ...
			  //search  
			      pag  = pag.findPagination(sql.toString(),pag,args,new RowMapper<ModelSysExport2>(){
			      @Override  
		            public ModelSysExport2 mapRow(ResultSet rs, int rowNum) throws SQLException {  
			    	  ModelSysExport2 info = new ModelSysExport2(); 
	...
	public void saveOne(String model_id, String[] ids, String[] names, String[] types, SysUser user) {
		...
		List<ModelSysExport2> list = new ArrayList<ModelSysExport2>();
		...
		modelSysExportRepository2.save(list);
	...
	public Object findSomeOne(ModelSysExport2 dto) {
		return modelSysExportRepository2.findOne(dto.getCol_id());
	}
	...
	public void saveSomeOne(ModelSysExport2 dto, SysUser user) {
		...
		modelSysExportRepository2.save(dto);
	}
	...
	public void delSomeData(String[] ids) {
		for (String id : ids) {
			modelSysExportRepository2.delete(id);	
		}
	}
