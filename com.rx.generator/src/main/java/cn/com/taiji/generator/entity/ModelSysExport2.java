...
@NamedQuery(name = "ModelSysExport2.findAll", query = " SELECT r FROM ModelSysExport2 r ")
public class ModelSysExport2 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2799836988171098825L;

	/**   fields   */
	public ModelSysExport2(){
