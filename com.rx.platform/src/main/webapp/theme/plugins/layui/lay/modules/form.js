    ...
    u = function() {
        this.config = {
            verify: {
                ...
                pass : [/^(\w){6,20}$/, '密码只能输入6-20个字母、数字、下划线' ],
        		lname:[/^[a-zA-Z]{1}([a-zA-Z0-9]|[._]){3,19}$/,'登录名只能输入4-20个以字母开头、可带数字、“_”、“.”的字串'],
        		length16:[/^.{0,17}$/,'输入字符长度超过16'],
        		length32:[/^.{0,33}$/,'输入字符长度超过32'],
        		length64:[/^.{0,65}$/,'输入字符长度超过64'],
        		length128:[/^.{0,129}$/,'输入字符长度超过128'],
        		length256:[/^.{0,257}$/,'输入字符长度超过256'],
    ...
    u.prototype.render = function(e, t) {
        ...
        d = {
            ...
            checkbox: function() {
                ...
                t.each(function(t, n) {
                    ...
                    function() {
                        ...
                        i = {
                            checkbox: [e ? "<span>" + n.title + "</span>": "", '<i class="layui-icon">'+ (r ? "√": "") + '</i>'].join(""),
            ...
            radio: function() {
                ...
                t = ["<img src='/theme/plugins/layui/images/icons/radio_y.png'/>", "<img src='/theme/plugins/layui/images/icons/radio.png'/>"],
